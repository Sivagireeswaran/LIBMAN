...
class menu:
    ...
    def addbook(self):
        ...
        self.aloc = StringVar()
        self.aprice = DoubleVar()    # Book Price as DoubleVar
        self.apublisher = StringVar()  # Publisher as StringVar
        self.ayear = IntVar()         # Published Year as IntVar

        self.f1 = Frame(self.a, height=600, width=650, bg='black')  # Adjusting frame height
        self.f1.place(x=500, y=100)

        # Book ID
        l1 = Label(self.f1, text='Book ID : ', font='Papyrus 12 bold', fg='Orange', bg='Black', pady=1).place(x=50, y=50)
        e1 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.aid).place(x=200, y=50)

        # Title
        l2 = Label(self.f1, text='Title : ', font='Papyrus 12 bold', fg='Orange', bg='Black', pady=1).place(x=50, y=100)
        e2 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.aname).place(x=200, y=100)

        # Author
        l3 = Label(self.f1, text='Author : ', font='Papyrus 12 bold', fg='Orange', bg='Black', pady=1).place(x=50, y=150)
        e3 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.aauthor).place(x=200, y=150)

        # Genre
        l4 = Label(self.f1, text='Genre : ', font='Papyrus 12 bold', fg='Orange', bg='Black', pady=1).place(x=50, y=200)
        e4 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.agenre).place(x=200, y=200)

        # Copies
        l5 = Label(self.f1, text='Copies : ', font='Papyrus 12 bold', fg='Orange', bg='Black', pady=1).place(x=50, y=250)
        e5 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.acopies).place(x=200, y=250)

        # Location
        l6 = Label(self.f1, text='Location : ', font='Papyrus 12 bold', fg='Orange', bg='Black', pady=1).place(x=50, y=300)
        e6 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.aloc).place(x=200, y=300)

        # Book Price
        l7 = Label(self.f1, text='Price : ', font='Papyrus 12 bold', fg='Orange', bg='Black', pady=1).place(x=50, y=350)
        e7 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.aprice).place(x=200, y=350)

        # Publisher
        l8 = Label(self.f1, text='Publisher : ', font='Papyrus 12 bold', fg='Orange', bg='Black', pady=1).place(x=50, y=400)
        e8 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.apublisher).place(x=200, y=400)

        # Published Year
        l9 = Label(self.f1, text='Published Year : ', font='Papyrus 12 bold', fg='Orange', bg='Black', pady=1).place(x=50, y=450)
        e9 = Entry(self.f1, width=45, bg='orange', fg='black', textvariable=self.ayear).place(x=200, y=450)

        self.f1.grid_propagate(0)

        # Buttons
        b1 = Button(self.f1, text='Add', font='Papyrus 10 bold', fg='black', bg='orange', width=15, bd=3, command=self.adddata).place(x=150, y=500)
        b2 = Button(self.f1, text='Back', font='Papyrus 10 bold', fg='black', bg='orange', width=15, bd=3, command=self.rm).place(x=350, y=500)
